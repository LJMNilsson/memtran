...
public class BuildAnnotation {
    ...
    ASTIndexing indexingOrNull; // is set by the eliminatePass 

    public BuildAnnotation(boolean isOwner, boolean shouldBeEliminated) {
        this.isOwner = isOwner;
        this.shouldBeEliminated = shouldBeEliminated;
        this.indexingOrNull = null;
    }
