...
public class IRAllocateEmptyArray extends IRInstruction {

    String receivingRegister;

    public IRAllocateEmptyArray(String receivingRegister) {
        this.receivingRegister = receivingRegister;
    }

    public String print() {
        return "head " + receivingRegister + " = AllocateEmptyArray";
    }
}
