...
public class IRCallArrayHeadFunction extends IRInstruction {

    String receivingRegister;
    String functionName;
    ArrayList<IRArg> args;

    public IRCallArrayHeadFunction(String receivingRegister, String functionName, ArrayList<IRArg> args) {
    ...
    public String print() {
        String result = "head " + receivingRegister + " = Call " + functionName + " ";
        for (IRArg arg : args) {
