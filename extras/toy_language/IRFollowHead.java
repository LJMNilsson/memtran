...
public class IRFollowHead extends IRInstruction {

    String receivingRegister;
    IRRegArrayHead head;
    IRInt index;

    public IRFollowHead(String receivingRegister, IRRegArrayHead head, IRInt index) {
    ...
    public String print() {
        return "head/int (FIX)" + receivingRegister + " = FollowHead " + head.print() + " " + index.print(); 
    }
