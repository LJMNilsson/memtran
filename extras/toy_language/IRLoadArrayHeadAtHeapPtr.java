...
public class IRLoadArrayHeadAtHeapPtr extends IRInstruction {

    String receivingRegister;
    IRRegHeapPtr ptr;
    
    public IRLoadArrayHeadAtHeapPtr(String receivingRegister, IRRegHeapPtr ptr) {
        this.receivingRegister = receivingRegister;
        this.ptr = ptr;
    }

    public String print() {
        return receivingRegister + " = LoadArrayHeadAtHeapPtr " + ptr.print();
    }
