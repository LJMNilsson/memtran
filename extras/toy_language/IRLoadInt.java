...
ublic class IRLoadInt extends IRInstruction {

    String receivingRegister;
    IRRegStackAddress addr;

    public IRLoadInt(String receivingRegister, IRRegStackAddress addr) {
        this.receivingRegister = receivingRegister;
        this.addr = addr;
    }

    public String print() {
        return receivingRegister + " = LoadInt " + addr.print();
    }
