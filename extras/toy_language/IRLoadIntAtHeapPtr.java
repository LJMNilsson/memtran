...
public class IRLoadIntAtHeapPtr extends IRInstruction {

    String receivingRegister;
    IRRegHeapPtr ptr;

    public IRLoadIntAtHeapPtr(String receivingRegister, IRRegHeapPtr ptr) {
        this.receivingRegister = receivingRegister;
        this.ptr = ptr;
    }

    public String print() {
        return receivingRegister + " = LoadIntAtHeapPtr " + ptr.print();
    }
