...
public class IRSetCFlag extends IRInstruction {

    String receivingRegister;
    IRRegArrayHead head;

    public IRSetCFlag(String receivingRegister, IRRegArrayHead head) {
        this.receivingRegister = receivingRegister;
        this.head = head;
    }

    public String print() {
        return receivingRegister + " = SetCFlag " + head.print();
    }
