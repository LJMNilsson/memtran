...
public class IRSetOwnsflag extends IRInstruction {
    String receivingRegister;
    IRRegArrayHead head;

    public IRSetOwnsflag(String receivingRegister, IRRegArrayHead head) {
        this.receivingRegister = receivingRegister;
        this.head = head;
    }

    public String print() {
        return receivingRegister + " = SetOwnsflag " + head.print();
    }
