...
public class IRUnOwnsflag extends IRInstruction {

    String receivingRegister;
    IRRegArrayHead head;

    public IRUnOwnsflag(String receivingRegister, IRRegArrayHead head) {
        this.receivingRegister = receivingRegister;
        this.head = head;
    }

    public String print() {
        return receivingRegister + " = UnOwnsflag " + head.print();
    }
